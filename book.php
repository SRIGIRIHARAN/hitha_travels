...
<head>
    ...
    <title>Hitha Travels | Booking Page</title>
    ...
    <section class="booking">
            <form action="book.php" method="post" class="book-form">
                ...
                <div class="flex">
                    ...
                    <div class="inputBox">
                        <span>Email :</span>
                        <input type="email" placeholder="enter your email" name="t2" required>
                    </div>
                    <div class="inputBox">
                        <span>Phone :</span>
                        <input type="number" placeholder="enter your number" name="t3" required>
                    </div>
                    <div class="inputBox">
                    ...
                    <div class="inputBox">
                        <span>Person :</span>
                        <input type="number" placeholder="number of guests" name="t5" required>
                    </div>
                    <div class="inputBox">
                        <span>Cab Type :</span>
                    ...
                    <div class="inputBox">
                        ...
                        <input type="text" placeholder="enter your address" name="t7" required>
                    </div>
                    <div class="inputBox">
                        <span>Dropoff Point :</span>
                        <input type="text" placeholder="place you want to visit" name="t8" required>
                    </div>
                </div>
...
if(isset($_POST['sub'])){
    ...
    $sql="insert into book(suname,smailid,sphone,saddress,sdesti,sperson,sarrive,sleave) 
